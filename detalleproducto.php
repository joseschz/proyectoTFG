               ...
               echo'<div class="col-xl-5 col-lg-5 col-md-6">
                ...
                echo'<div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        ...
                        <form id="formulario_producto" method="post">
                            <input type="hidden" name="id" value="'.openssl_encrypt($row['ID_Producto'], COD, KEY).'">
                            <input type="hidden" name="nombre" value="'.openssl_encrypt($row['Nombre'],COD,KEY).'">
                            <input type="hidden" name="precio" value="'.openssl_encrypt($row['Precio'],COD,KEY).'">
                            <input type="hidden" name="imagen" value="'.openssl_encrypt($row['imagen'],COD,KEY).'">
                            <input type="hidden" name="cantidad" value="'.openssl_encrypt(1,COD,KEY).'">
                                <button class="cart" name="btnAccion"
                                value="agregar"
                                type="submit">
                                Añadir al carrito</button>
                        </form>
                            </div>
						</div>
