...
<div class="instagram-box">
				...
				<div class="row">
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="footer-top-box">
							...
							<ul class="list-time">
								<li>Lunes - Viernes: 11.00am a 12.00pm</li> <li>Sábados: 11.00am to 05.00pm</li> <li>Domingos: <span>No atendemos</span></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-4 col-md-12 col-sm-12">
   ...
   <div class="footer-copyright">
        <p class="footer-company">Todos los derechos reservados. &copy; 2024 Dulces y Eventos</p>
    </div>
    <a href="#" id="back-to-top" title="Volver al principio" style="display: none;">&uarr;</a>
    <!-- JS FICHEROS -->
