                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                      <div class="card-title mb-0">
                        <h5 class="m-0 me-2" >Estadísticas de 4 Pedidos más comprados</h5>
                      </div>
                  ...
                  <div class="card h-100">
                    <div class="card-body px-0">
                      <div class="tab-content p-0">
                        ...
                        <h5 class="m-0 me-2" style="text-align: center">Gráfica de beneficios por mes.</h5>
                    ...
                    <div class="card-body">
                      ...
                      foreach($resultado as $row){
                        ...
                        <div class="avatar flex-shrink-0 me-3">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              <small class="text-muted d-block mb-1"><strong>'.$row[0].'</strong></small>
                              <h6 class="mb-0"><strong>La suma de productos comprados en esta tienda son: <strong style="color:green;">'.$row[4].'</strong></strong> Productos</h6>
                            </div>
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0">Gastado en una compra : <strong style="color:green;">+'.$row[5].'</strong></h6>
