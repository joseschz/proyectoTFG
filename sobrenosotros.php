...
?>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="images/ins-bg.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <h2 class="noo-sh-title-top">SOBRE <span>DULCES Y EVENTOS</span></h2>
					...
					<a class="btn hvr-hover" href="contacto.php">Contactanos</a>
                </div>
            </div>
            <div class="row my-5">
